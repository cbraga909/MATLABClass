...
[x,h]=ode45(@threeeqs,[0,1],[0,0,0.332]);
%Create plot using ode45 again, but without assigning values
ode45(@threeeqs,[0,1],[0 0 0.332]);
%Label plot
title('h values vs. x'),xlabel('x-axis'),ylabel('h-axis'),legend('h1','h2','h3')

%Create table of values
sol=table(h(:,1),h(:,2),h(:,3));
%Name the variables in the table
sol.Properties.VariableNames={'h1','h2','h3'}
